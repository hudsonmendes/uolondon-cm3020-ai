...
class FitnessTest(unittest.TestCase):
    ...
    def test_report_creature_movement_keeps_record_of_first_and_last_positions(self, mock_creature: Mock):
        ...
        [self.fitness.report_movement(mock_creature, dist) for dist in distances_walked]
        actual = self.fitness.tracker_for(mock_creature)
    ...
    def test_fittest_shows_creature_who_travelled_furthest(self):
        ...
        self.fitness.report_movement(creature1, (0.1, 0.2, 0.3))
        self.fitness.report_movement(creature2, (1., 2., 3.))
        self.fitness.report_movement(creature3, (10., 20., 30.))
        top1 = self.fitness.calculate_fittest_from(self.population)
